...
export default function Home() {
  ...
  return (
    <main className="relative z-10 flex flex-col items-center justify-center pt-16 px-4 text-center max-w-6xl mx-auto w-full">
      ...
      {/* بخش امکانات و سیستم‌های اختصاصی */}
      <motion.div 
      ...
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} className="liquid-glass p-6 rounded-xl cursor-pointer border border-purple-500/20">
            ...
            <p className="text-sm text-gray-400">طراحی مدرن، سبک و روان برای دسترسی لحظه‌ای به وضعیت شهر.</p>
          </Tilt>
          ...
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} className="liquid-glass p-6 rounded-xl cursor-pointer border border-purple-500/20">
            ...
            <p className="text-sm text-gray-400">تیونینگ حرفه‌ای خودروها، منوهای کاستوم NUI و تعمیرات.</p>
          </Tilt>
          ...
          <Tilt tiltMaxAngleX={10} tiltMaxAngleY={10} scale={1.05} className="liquid-glass p-6 rounded-xl cursor-pointer border border-purple-500/20">
            ...
            <p className="text-sm text-gray-400">مدیریت سریع آیتم‌ها و سلاح‌ها با سیستم Drag & Drop.</p>
          </Tilt>
